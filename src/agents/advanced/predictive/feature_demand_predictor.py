...
class FeatureDemandPredictorAgent(BaseAgent):
    ...
    async def process(self, state: AgentState) -> AgentState:
        ...
        top_features = [
            {
                ...
                "predicted_requests": 45,
                "current_requests": 12,
                "growth": "+275%",
                "customer_segments": ["enterprise", "data-heavy"],
            },
            {
                "feature": "Slack Integration v2",
                "predicted_requests": 38,
                "current_requests": 8,
                "growth": "+375%",
                "trigger": "Competitor launched similar",
            },
        ]
        ...
        return self.update_state(
            ...
            feature_predictions=top_features,
            status="resolved",
