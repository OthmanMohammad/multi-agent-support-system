...
class ConversionPredictorAgent(BaseAgent):
    ...
    def __init__(self):
        config = AgentConfig(name="conversion_predictor", type=AgentType.ANALYZER, temperature=0.1, max_tokens=1000, capabilities=[AgentCapability.DATABASE_READ, AgentCapability.CONTEXT_AWARE], tier="advanced")
