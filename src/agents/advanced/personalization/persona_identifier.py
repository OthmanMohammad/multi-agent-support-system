...
class PersonaIdentifierAgent(BaseAgent):
    ...
    PERSONAS = {
        "executive": "C-level, ROI-focused",
        "power_user": "Technical, API-heavy",
        "manager": "Team lead",
        "casual_user": "Occasional use",
        "champion": "Advocate",
    }
...
**Communication Style:** {persona["communication_guidelines"]}"""
        ...
        return self.update_state(
            ...
            persona=persona,
            status="resolved",
            response_confidence=persona["confidence"],
            next_agent=None,
        )
        ...
        if context and hasattr(context, "customer"):
            ...
            if any(w in title for w in ["ceo", "cto", "vp", "director"]):
                return {
                    "persona": "executive",
                    "confidence": 0.9,
                    "communication_guidelines": "High-level, ROI-focused",
                }
            elif api_calls > 1000:
                return {
                    "persona": "power_user",
                    "confidence": 0.85,
                    "communication_guidelines": "Technical depth, code examples",
                }
            elif team_size > 5:
                return {
                    "persona": "manager",
                    "confidence": 0.8,
                    "communication_guidelines": "Team-focused, collaboration",
                }
            else:
                return {
                    "persona": "casual_user",
                    "confidence": 0.6,
                    "communication_guidelines": "Simple, step-by-step",
                }

        return {
            "persona": "casual_user",
            "confidence": 0.5,
            "communication_guidelines": "General, helpful",
        }
