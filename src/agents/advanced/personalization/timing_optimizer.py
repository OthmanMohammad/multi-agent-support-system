...
class TimingOptimizerAgent(BaseAgent):
    ...
    def __init__(self):
        config = AgentConfig(name="timing_optimizer", type=AgentType.ANALYZER, model="claude-3-haiku-20240307", temperature=0.1, max_tokens=600, capabilities=[AgentCapability.DATABASE_READ], tier="advanced")
