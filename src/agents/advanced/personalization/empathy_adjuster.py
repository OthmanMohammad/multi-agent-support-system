...
class EmpathyAdjusterAgent(BaseAgent):
    ...
    def __init__(self):
        config = AgentConfig(name="empathy_adjuster", type=AgentType.COORDINATOR, model="claude-3-haiku-20240307", temperature=0.3, max_tokens=800, capabilities=[], tier="advanced")
