...
class ResponsePersonalizerAgent(BaseAgent):
    ...
    def __init__(self):
        config = AgentConfig(name="response_personalizer", type=AgentType.COORDINATOR, temperature=0.3, max_tokens=1500, capabilities=[AgentCapability.CONTEXT_AWARE], tier="advanced")
