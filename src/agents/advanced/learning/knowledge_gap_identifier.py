"""
KnowledgeGapIdentifier Agent - Identifies gaps in knowledge base, agent capabilities, and training data
...
Part of: EPIC-004 Learning & Improvement Swarm (TASK-4057)
"""
...
class KnowledgeGapIdentifierAgent(BaseAgent):
    """
    KnowledgeGapIdentifier - Identifies gaps in knowledge base, agent capabilities, and training data
    ...
    def __init__(self):
        ...
        self.logger = logger.bind(agent="knowledge_gap_identifier")

    def _get_system_prompt(self) -> str:
        """Get the system prompt."""
        return """You are an expert AI analyst specialized in identifies gaps in knowledge base, agent capabilities, and training data.
...
Base your analysis on the data provided and industry best practices."""
    ...
    async def process(self, state: AgentState) -> AgentState:
        """
        Perform identifies gaps in knowledge base, agent capabilities, and training data.
        ...
        try:
            ...
            self.logger.info(
                "knowledge_gap_identifier_completed",
            ...
            self.logger.error("knowledge_gap_identifier_error", error=str(e), exc_info=True)
            return self.update_state(
                state,
    ...
    def _build_response(self, analysis_result: Dict[str, Any]) -> str:
        ...
        output.append(f"# KnowledgeGapIdentifier Analysis Report")
        output.append("")
