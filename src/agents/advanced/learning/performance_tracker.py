"""
PerformanceTracker Agent - Tracks and reports on agent performance metrics, trends, and anomalies
...
Part of: EPIC-004 Learning & Improvement Swarm (TASK-4058)
"""
...
class PerformanceTrackerAgent(BaseAgent):
    """
    PerformanceTracker - Tracks and reports on agent performance metrics, trends, and anomalies
    ...
    def __init__(self):
        ...
        self.logger = logger.bind(agent="performance_tracker")

    def _get_system_prompt(self) -> str:
        """Get the system prompt."""
        return """You are an expert AI analyst specialized in tracks and reports on agent performance metrics, trends, and anomalies.
...
Base your analysis on the data provided and industry best practices."""
    ...
    async def process(self, state: AgentState) -> AgentState:
        """
        Perform tracks and reports on agent performance metrics, trends, and anomalies.
        ...
        try:
            ...
            self.logger.error("performance_tracker_error", error=str(e), exc_info=True)
            return self.update_state(
                state,
    ...
    def _build_response(self, analysis_result: Dict[str, Any]) -> str:
        ...
        output.append(f"# PerformanceTracker Analysis Report")
        output.append("")
