"""
RoutingOptimizer Agent - Optimizes agent routing decisions based on historical performance data
...
Part of: EPIC-004 Learning & Improvement Swarm (TASK-4059)
"""
...
@AgentRegistry.register("routing_optimizer", tier="advanced", category="learning")
class RoutingOptimizerAgent(BaseAgent):
    """
    RoutingOptimizer - Optimizes agent routing decisions based on historical performance data
    ...
    def __init__(self):
        ...
        self.logger = logger.bind(agent="routing_optimizer")

    def _get_system_prompt(self) -> str:
        """Get the system prompt."""
        return """You are an expert AI analyst specialized in optimizes agent routing decisions based on historical performance data.
...
Base your analysis on the data provided and industry best practices."""
    ...
    async def process(self, state: AgentState) -> AgentState:
        """
        Perform optimizes agent routing decisions based on historical performance data.
        ...
        """
        self.logger.info("routing_optimizer_started")
        ...
        try:
            ...
            self.logger.error("routing_optimizer_error", error=str(e), exc_info=True)
            return self.update_state(
                state,
    ...
    def _build_response(self, analysis_result: Dict[str, Any]) -> str:
        ...
        output.append(f"# RoutingOptimizer Analysis Report")
        output.append("")
