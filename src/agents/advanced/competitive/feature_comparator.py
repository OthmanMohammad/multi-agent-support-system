...
class FeatureComparatorAgent(BaseAgent):
    ...
    def __init__(self):
        config = AgentConfig(name="feature_comparator", type=AgentType.ANALYZER, temperature=0.2, max_tokens=1200, capabilities=[AgentCapability.DATABASE_READ], tier="advanced")
