...
class PricingAnalyzerAgent(BaseAgent):
    ...
    def __init__(self):
        config = AgentConfig(name="pricing_analyzer", type=AgentType.ANALYZER, model="claude-3-haiku-20240307", temperature=0.2, max_tokens=1200, capabilities=[AgentCapability.DATABASE_READ], tier="advanced")
