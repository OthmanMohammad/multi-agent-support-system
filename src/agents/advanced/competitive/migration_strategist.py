...
class MigrationStrategistAgent(BaseAgent):
    ...
    def __init__(self):
        config = AgentConfig(name="migration_strategist", type=AgentType.ANALYZER, temperature=0.2, max_tokens=1200, capabilities=[AgentCapability.DATABASE_READ], tier="advanced")
