...
class WinLossAnalyzerAgent(BaseAgent):
    ...
    def __init__(self):
        config = AgentConfig(name="win_loss_analyzer", type=AgentType.ANALYZER, temperature=0.2, max_tokens=1200, capabilities=[AgentCapability.DATABASE_READ], tier="advanced")
