...
class ChangelogWriterAgent(BaseAgent):
    ...
    def __init__(self):
        config = AgentConfig(name="changelog_writer", type=AgentType.COORDINATOR, temperature=0.5, max_tokens=4000, capabilities=[AgentCapability.KB_SEARCH, AgentCapability.DATABASE_WRITE], tier="advanced")
