...
class TutorialCreatorAgent(BaseAgent):
    ...
    def __init__(self):
        config = AgentConfig(name="tutorial_creator", type=AgentType.COORDINATOR, model="claude-3-5-sonnet-20240620", temperature=0.5, max_tokens=4000, capabilities=[AgentCapability.KB_SEARCH, AgentCapability.DATABASE_WRITE], tier="advanced")
