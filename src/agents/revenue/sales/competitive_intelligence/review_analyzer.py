...
class ReviewAnalyzer(BaseAgent):
    ...
    async def process(self, state: AgentState) -> AgentState:
        ...
        positioning_recommendations = self._generate_positioning(
            review_analyses, opportunities, threats
        )
    ...
    def _identify_competitors(self, message: str, state: AgentState) -> list[str]:
        ...
        for competitor_key in self.COMPETITOR_REVIEWS:
    ...
    def _analyze_competitor_reviews(self, competitor: str) -> dict[str, Any]:
        ...
        return {
            ...
            "review_credibility": "high"
            if review_data.get("total_reviews", 0) > 1000
            else "medium",
    ...
    def _generate_comparative_insights(self, review_analyses: list[dict]) -> list[dict[str, Any]]:
        ...
        avg_competitor_rating = (
            sum(r["overall_rating"] for r in review_analyses) / len(review_analyses)
            if review_analyses
            else 0
        )
                ...
                opportunities.append(
                    {
                        ...
                        "our_positioning": "We solve this by...",
    ...
    def _generate_battle_card_points(self, review_analyses: list[dict]) -> list[dict[str, Any]]:
        ...
        for analysis in review_analyses:
            ...
            battle_card = {
                ...
                "their_strengths": list(analysis.get("common_positives", [])[:3]),
                "their_weaknesses": list(analysis.get("common_negatives", [])[:3]),
                "our_talking_points": [],
                "objection_handlers": [],
            }
                ...
                battle_card["objection_handlers"].append(
                    {
                        ...
                        "response": "Yes, they do well there. We match their capabilities and also provide...",
                    }
                )
    ...
    def _generate_positioning(
        self, review_analyses: list[dict], opportunities: list[dict], threats: list[dict]
    ) -> list[str]:
        """Generate positioning recommendations"""
        recommendations = []
        ...
        for weakness, count in sorted(common_weaknesses.items(), key=lambda x: x[1], reverse=True)[
            :3
        ]:
            if count >= 2:
        ...
        # General positioning
        recommendations.append(
            "Lead with ease of use and value - common pain points across competitors"
        )
...
if __name__ == "__main__":
    ...
    async def test():
        ...
        state2 = create_initial_state(
            ...
            context={"customer_metadata": {"company": "GrowthCo", "industry": "saas"}},
        )
        ...
        state3 = create_initial_state(
            "I want to understand the competitive landscape based on customer reviews", context={}
        )
