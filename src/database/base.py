...
class BaseRepository(Generic[ModelType]):
    ...
    async def create(self, created_by: UUID | None = None, **kwargs) -> ModelType:
        """
    ...
    async def bulk_create(
        self, items: list[dict], created_by: UUID | None = None
    ) -> list[ModelType]:
        """
    ...
    async def update(
        self, id: UUID, updated_by: UUID | None = None, _allow_none: bool = False, **kwargs
    ) -> ModelType | None:
        """
    ...
    async def soft_delete_by_id(self, id: UUID, deleted_by: UUID | None = None) -> ModelType | None:
        """
    ...
    async def get_deleted(self, limit: int = 100, offset: int = 0) -> list[ModelType]:
        """
    ...
    async def find_by(self, exclude_deleted: bool = True, **filters) -> list[ModelType]:
        """
    ...
    async def find_one_by(self, exclude_deleted: bool = True, **filters) -> ModelType | None:
        """
