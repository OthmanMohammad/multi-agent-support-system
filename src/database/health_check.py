...
from src.database.connection import check_db_health, close_db, get_db_session, get_db_version
from src.database.models import AgentPerformance, Conversation, Customer, Message
...
async def run_health_check():
    ...
    async with get_db_session() as session:
        ...
        for table_name, _model in tables.items():
            try:
    ...
    async with get_db_session() as session:
        ...
        current_table = None
        for _schema, table, index in indexes:
