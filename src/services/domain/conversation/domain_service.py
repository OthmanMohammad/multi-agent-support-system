...
class ConversationDomainService:
    ...
    def validate_conversation_creation(
        self, customer_plan: str, today_conversation_count: int, customer_blocked: bool
    ) -> Result[None]:
        """
    ...
    def calculate_resolution_time(
        self, started_at: datetime, ended_at: datetime | None = None
    ) -> int:
        """
    ...
    def determine_escalation_priority(
        self, customer_plan: str, urgency: str, sentiment_avg: float | None, annual_value: float
    ) -> str:
        """
        ...
        # Customer tier score
        tier_scores = {"free": 0, "basic": 1, "premium": 2, "enterprise": 3}
    ...
    def create_conversation_reopened_event(
        self, conversation_id: UUID, customer_id: UUID, reason: str, previous_status: str
    ) -> ConversationReopenedEvent:
