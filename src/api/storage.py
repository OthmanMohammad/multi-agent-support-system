...
class ConversationStore:
    ...
    def create_conversation(
        self, conversation_id: str | None = None, customer_id: str = "default_customer"
    ) -> str:
        """
    ...
    def add_message(
        self, conversation_id: str, role: str, content: str, agent_name: str | None = None
    ):
        """
    ...
    def update_agent_history(self, conversation_id: str, agent_history: list[str]):
    ...
    def list_conversations(self, customer_id: str | None = None, limit: int = 50) -> list[dict]:
        """
        List conversations
        ...
        # Filter by customer
        if customer_id:
            conversations = [c for c in conversations if c["customer_id"] == customer_id]
