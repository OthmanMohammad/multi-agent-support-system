...
class AgentInfo(BaseModel):
    ...
    category: Optional[str] = Field(None, description="Agent category (routing, billing, etc.)")
    ...
    required_scopes: List[str] = Field(default=[], description="Required permission scopes to execute")
...
class AgentExecuteRequest(BaseModel):
    ...
    max_tokens: Optional[int] = Field(None, ge=100, le=4096, description="Max tokens override")
