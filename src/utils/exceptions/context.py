...
def get_exception_correlation_id(exc: Exception) -> str | None:
    """
...
def get_exception_customer_id(exc: Exception) -> str | None:
    """
...
def get_exception_conversation_id(exc: Exception) -> str | None:
    """
...
def get_exception_agent_name(exc: Exception) -> str | None:
    """
